...
replacement = '''
    ...
    if broker_filter == 'analysis':
        # Combine all assets: ticker_summary + family_assets
        all_items = []
        ...
        country_group = {'미국 자산': 0, '한국 자산': 0, '현금성 자산': 0}
        sector_group = {}
        stock_group = {}
        ...
        for item in all_items:
            ...
            if any(k in name for k in cash_keywords):
                country_group['현금성 자산'] += amt
            elif any(k in name for k in us_keywords):
            ...
            # 3. Stock Group
            stock_group[name] = stock_group.get(name, 0) + amt
