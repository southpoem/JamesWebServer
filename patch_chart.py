...
target = '''                // --- 1. Total Asset Trend Chart ---
                    ...
                    options: {
                        ...
                        scales: {
                            ...
                            y: { 
                                ...
                                ticks: { color: '#aaa', callback: function(value) { return (value / 10000).toLocaleString() + '만'; } }
                            }
                        }
                    }
                });'''
                                ...
                                callbacks: {
                                    ...
                                    footer: function(tooltipItems) {
                                        ...
                                        if (tooltipItems[0].dataIndex > 0) {
                                            ...
                                            trendCtx.chart.data.datasets.forEach(function(dataset) {
...
if target in content:
    ...
    with open(r'C:\PycharmProjects\JamesWebServer\templates\infinite_assets.html', 'w', encoding='utf-8') as f:
        f.write(content)
    print("Trend chart replaced successfully.")
else:
    print("Trend chart target not found.")
